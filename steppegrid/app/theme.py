...
COLORS = {
    ...
    "border": "#D8E0DB", "text": "#17211D",
}

GLOBAL_CSS = """
<style>
:root { --sg-primary:#1F6B5B;--sg-wind:#2878A6;--sg-solar:#D59A16;--sg-storage:#7359A6;--sg-unmet:#B84A45;--sg-curtail:#B06F2E;--sg-text:#17211D;--sg-muted:#66736D;--sg-border:#D8E0DB;--sg-surface:#FFFFFF;--sg-surface-alt:#EDF2EE; }
