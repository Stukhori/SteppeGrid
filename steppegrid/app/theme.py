...
@media(max-width:640px){.block-container{padding-top:1.25rem;padding-bottom:2.5rem}h1{font-size:1.9rem!important}.sg-lead{font-size:.96rem}.sg-badges{gap:.3rem}.sg-workflow{grid-template-columns:1fr}[data-testid="stMetric"]{min-height:96px;padding:.8rem}}
</style>
"""
