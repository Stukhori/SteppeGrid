...
Shamshi Kaldayakova is highlighted in blue as `MY VILLAGE`. Its current registered demand is 0.50 GWh per year. The standardized 95% planning result uses 200 kW of wind, 347.8 kWdc of solar, and 1.03 MWh of storage, supplying 95.83% of modeled annual electricity. The 99% result supplies 99.12% with 500 kW wind, 298.1 kWdc solar, and 1.54 MWh storage. The current figures are active planning data, not a claim of on-site metering. The software keeps its source records and data hashes so future field measurements can be substituted cleanly.
